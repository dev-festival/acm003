...
```{python}
#| echo: false
#| label: OLD-technology-defitinitions
...
# Build needs coverage
needs_coverage = (
    config['class_component']
    .merge(config['classes'][['class_id', 'class_name']], on='class_id')
    .merge(config['component_technology'][['component_id', 'technology_code', 'application_type']], on='component_id')
    .merge(config['components'][['component_id', 'component_name']], on='component_id')
    [['class_name', 'component_name', 'technology_code', 'application_type']]
    .rename(columns={'class_name': 'ASSET_CLASS', 'technology_code': 'TECH'})  # Match your SQL column name
)
...
```{python}
#| echo: false
#| label: OLD-needs-monitoring-function
...
```{python}
#| echo: false
#| label: OLD-build-needs-coverage
...
```{python}
#| echo: false
#| label: OLD-output-needs-coverage
...
```{python}
#| echo: false
#| label: OLD-merge-needs-with-assets
...
```{python}
#| echo: false
#| label: OLD-output-assets_with_needs
...
```{python}
#| echo: false
#| label: OLD-needs-by-dept-primary-only
...
```{python}
#| echo: true
#| label: OLD-merge-needs-has-coverage
